...
SentaiA1["1"] = Instance.new("ScreenGui", game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui"));
SentaiA1["1"]["ZIndexBehavior"] = Enum.ZIndexBehavior.Sibling;

SentaiA1["2"] = Instance.new("Frame", SentaiA1["1"]);
SentaiA1["2"]["BorderSizePixel"] = 0;
SentaiA1["2"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0);
SentaiA1["2"]["Size"] = UDim2.new(0, 50, 0, 50);
SentaiA1["2"]["Draggable"] = true
SentaiA1["2"]["Position"] = UDim2.new(0.20, 0, -0.1, 0);
SentaiA1["2"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);


SentaiA1["3"] = Instance.new("UICorner", SentaiA1["2"]);
SentaiA1["3"]["CornerRadius"] = UDim.new(1, 0);

SentaiA1["4"] = Instance.new("TextButton", SentaiA1["2"]);
SentaiA1["4"]["TextWrapped"] = true;
SentaiA1["4"]["BorderSizePixel"] = 0;
SentaiA1["4"]["TextSize"] = 14;
SentaiA1["4"]["TextColor3"] = Color3.fromRGB(255, 255, 255);
SentaiA1["4"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
SentaiA1["4"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
SentaiA1["4"]["Size"] = UDim2.new(0, 50, 0, 56);
SentaiA1["4"]["BackgroundTransparency"] = 1;
SentaiA1["4"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
SentaiA1["4"]["Text"] = [[STOP TWEEN]];
SentaiA1["4"]["Position"] = UDim2.new(0, 0, -0.07273, 0);
SentaiA1["5"] = Instance.new("UIStroke", SentaiA1["4"]);
SentaiA1["5"]["Color"] = Color3.fromRGB(255, 0, 0);

SentaiA1["6"] = Instance.new("UIStroke", SentaiA1["2"]);
SentaiA1["6"]["Color"] = Color3.fromRGB(169, 238, 8);
...
SentaiA1["4"].MouseButton1Click:Connect(function()
    StopTween()
end)
